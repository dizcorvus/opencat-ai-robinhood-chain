  ...
  public getToolDefinitions(): AthenaToolDefinition[] {
    return [
      ...
      },
      {
        ...
        description: 'Update runtime screening thresholds for a sub-agent (meme-solana, meme-robinhood). Whitelisted keys only; out-of-range values are rejected, never silently changed. Valid keys (meme agents): minVolume24hUsd (1000-100000000), minLiquidityUsd (1000-100000000), minAgeHours (0-168; 0 = degen early, token baru lolos), maxRugRatio (0.01-1), maxRatTraderRate (0.01-1), maxTop10HolderRate (0.01-1), minTotalFeeUsd (0-1000000; 500 = default, 0 = gate fee mati), passThreshold (50-99), rankLimit (10-100), trenchesLimit (10-80), hotSearchesLimit (10-500), signalTypes (array of ints 1-21, e.g. [6,7,11,12]). Persisted across restarts.',
        parameters: {
          type: 'object',
          properties: {
