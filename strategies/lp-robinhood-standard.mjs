export default {
  id: 'lp-robinhood-standard',
  name: 'Robinhood LP Velocity (Standard — strict thresholds)',
  version: '1.0.0',
  description:
    'Standard preset: strict thresholds (2x tighter than default). ' +
    'Concentrated-liquidity pools on Robinhood Chain (Uniswap v3 via Krystal). ' +
    'Hard gates: TVL >= $20k, 24h volume >= $200k, 24h Fee/TVL >= 4%, meme-token market cap >= $200k, security audit pass. ' +
    'Fail-closed: missing pool data = SKIP. Confidence 80 when all gates pass. No LLM.',
  params: {
    passThreshold: 80,
    minTvlUsd: 20000,
    minVol24hUsd: 200000,
    minFeeTvlRatio24h: 0.04,
