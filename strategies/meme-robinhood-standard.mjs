export default {
  ...
  params: {
    ...
    minTotalFeeUsd: 500,
    prefilterVolume1hUsd: 50000,
    prefilterLiquidityUsd: 10000,
    prefilterTotalFeeUsd: 500,
    prefilterRugRatio: 0.3,
    prefilterRatTraderRate: 0.3,
    prefilterTop10HolderRate: 0.4,
  },
  evaluate(ctx) {
    const p = this.params;
