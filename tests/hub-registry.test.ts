...
const mkMeteoraPool = (): MeteoraPoolSignal => ({
  ...
  feesToTvlRatio4h: 0.002,
  volumeToTvlRatio4h: 0.27,
  volumeToActiveTvlRatio4h: 0.33,
  organicVolumeScore4h: 88,
  recommendedDistribution: 'Spot',
  aiRecommendation: 'Live Meteora pool (via DexScreener): SOL-USDC',
});
...
const mkUniswapPool = (): UniswapPoolSignal => ({
  ...
  feesToTvlRatio4h: 0.001,
  volumeToTvlRatio4h: 0.3,
  volumeToActiveTvlRatio4h: 0.33,
  organicVolumeScore4h: 75,
